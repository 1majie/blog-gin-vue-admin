 ...
 * ```
 */
export declare type ContentCallback = (fileName: string) => string | null | undefined;
/**
 * Add banner comments to files
 * @param pluginOptions - A comment content or An option
 */
export default function (pluginOptions: string | BannerPluginOptions | ContentCallback): any;
